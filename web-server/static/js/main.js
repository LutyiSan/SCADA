...
function formDisplayClose(close, form){
let closeElem  = document.querySelector(close);
let formElem = document.querySelector(form);
closeElem.addEventListener("click", function(){
formElem.style.display = 'none';
...
formDisplayClose("#close-type-tag","#type-tag");
formDisplayClose("#close-bacnet-tag","#bacnet-tag");
formDisplayClose("#close-modbus-tag","#modbus-tag");
}